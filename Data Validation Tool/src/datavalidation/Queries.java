...
public class Queries {
	...
	public void mapQuery(String queryID) 
	{
		...
		{
			errorMsg[list] = "DataError-0027: Germplasm with certain name types occurring more than once";
			...
			list++;
			errorMsg[list] = "DataError-0028: Germplasm with both CRSNM and LNAME name types";
			...
			list++;
			errorMsg[list] = "DataError-0029: Germplasm with both RELNM and COLNO name types";
		...
		{
			errorMsg[list] = "DataError-0030A: Multiple germplasms sharing the same name (ACCNO)";
			...
			list++;
			errorMsg[list] = "DataError-0030B: Multiple germplasms sharing the same name (ITEST)";
			...
			list++;
			errorMsg[list] = "DataError-0030C: Multiple germplasms sharing the same name (GACC)";
			...
			list++;
			errorMsg[list] = "DataError-0030D: Germplasm sharing a RELNM (release name) with another germplasm in the SAME country";
		...
		{
			errorMsg[list] = "DataError-0036A: Genebank accessions (name type GACC) with MTYPE <> Management (MAN)";
			...
			list++;
			errorMsg[list] = "DataError-0036B: Genebank accessions (name type GACC) with MGID = 0";
			...
			list++;
			errorMsg[list] = "DataError-0036C: Genebank accessions (name type GACC) with GPID1 <> MGID.";
			...
			list++;
			errorMsg[list] = "DataError-0036D: Genebank accessions (name type GACC) with GPID1 <> MGID'S GPID1";
			...
			list++;
			errorMsg[list] = "DataError-0036E: International Rice Genebank Collection (IRGC) accession with Cross Name (NTYPE = 2)";
		...
		{
			errorMsg[list] = "DataError-0014: MAN germplasm with inherited name from GPID2 but NSTAT not inherited";
			...
			list++;
			errorMsg[list] = "DataError-0015: Germplasm with inherited name from GPID2 but NDATE not inherited";
			...
			list++;
			errorMsg[list] = "DataError-0016: Germplasm with inherited name from GPID2 but NLOCN not inherited";
		...
		{
			errorMsg[list] = "DataError-0019: Germplasm with invalid name type as preferred name";
		...
		{
			errorMsg[list] = "DataError-0021: Germplasm with invalid name type as preferred ID";
			...
			list++;
			errorMsg[list] = "DataError-0022: Germplasm with preferred ID not unique for the given name type";
		...
		{
			errorMsg[list] = "DataError-0001: Unknown group source";
			...
			list++;
			errorMsg[list] = "DataError-0002: Germplasm with non-generative group source";
		...
		{
			errorMsg[list] = "DataError-0003: 1st level circular reference";
			//GPID 1
			...
			list++;
			errorMsg[list] = "DataError-0004: 2nd level circular reference";
			//GPID 1
			...
			list++;
			errorMsg[list] = "DataError-0005: 3rd level circular reference";
			//GPID 1
		...
		{
			errorMsg[list] = "DataError-0006A: Incorrect germplasm method (Method = DER but GNPGS <> -1)";
			...
			list++;
			errorMsg[list] = "DataError-0006B: Incorrect germplasm method (Method = GEN but GNPGS < 0)";	
		...
		{
			errorMsg[list] = "DataError-0023B: Germplasm with GLOCN different from GLOCN of GPID2 (METHOD <> IMPORT)";
		...
		{
			errorMsg[list] = "DataError-0007A: Germplasm with deleted parent references (GPID1)";
			...
			list++;
			errorMsg[list] = "DataError-0007B: Germplasm with deleted parent references (GPID2)";
			...
			list++;
			errorMsg[list] = "DataError-0007C: Germplasm with deleted parent references (MGID)";
		...
		{
			errorMsg[list] = "DataError-0015A: Germplasm with replaced parent references (GPID1)";
			...
			list++;
			errorMsg[list] = "DataError-0015B: Germplasm with replaced parent references (GPID2)";
			...
			list++;
			errorMsg[list] = "DataError-0015C: Germplasm with replaced parent references (MGID)";
		...
		{
			errorMsg[list] = "DataError-0008: Germplasm with no NAMES records"; 
		...
		{
			errorMsg[list] = "DataError-0032: Germplasm with duplicate names"; 
		...
		{
			errorMsg[list] = "DataError-0010: Germplasm with possible duplicate names (NTYPE-NSTAT combination occurring more than once)";
		...
		{
			errorMsg[list] = "DataError-0024: Invalid method-name type combination for method GEN (generative)";
			...
			list++;
			errorMsg[list] = "DataError-0025: Invalid method-name type combination for method DER (derivative)";
			...
			list++;
			errorMsg[list] = "DataError-0026: Invalid method-name type combination for method MAN (maintenance)";
		...
		{
			errorMsg[list] = "DataError-0011: Germplasm with no preferred ID (NSTAT=8) and no existing preferred English name";
			...
			list++;
			errorMsg[list] = "DataError-0020: Germplasm with multiple preferred IDs (NSTAT=8)";
		...
		{
			errorMsg[list] = "DataError-0017: Germplasm with multiple preferred English names (NSTAT=1)";
			...
			list++;
			errorMsg[list] = "DataError-0018: Germplasm with no preferred English name (NSTAT=1) and no existing preferred ID";
		...
		{
			errorMsg[list] = "DataError-0034A: Germplasm with METHOD = IMPORT but with no germplasm creation date";
			...
			list++;
			errorMsg[list] = "DataError-0034B: Germplasm with incorrect creation date (GDATE) format";
			...
			list++;
			errorMsg[list] = "DataError-0034C: Germplasm with creation date (GDATE) after current date";
		...
		{
			errorMsg[list] = "DataError-0012: Germplasm with germplasm creation date (GDATE) earlier than GDATE of parent (GPID1, GPID2 or both)";
			...
			list++;
			errorMsg[list] = "DataError-0013: Germplasm with germplasm creation date (GDATE) earlier than GDATE of MGID";
		...
		{
			errorMsg[list] = "DataError-0035A: Germplasm with incorrect name date (NDATE) format";
			...
			list++;
			errorMsg[list] = "DataError-0035B: Germplasm with NAME date (NDATE) after current date";
		...
		{
			errorMsg[list] = "DataError-0033: Germplasm with non-inherited name but name date (NDATE) earlier than germplasm creation date (GDATE)";
